...
// is deferred. The `loading` skeleton reserves roughly the right height so real
// visitors don't see a jump when the JS chunk arrives.
const PracticeSection = dynamic(() => import("@/components/games/PracticeSection"), {
  loading: () => <div className="py-16 md:py-20 bg-cream" aria-hidden="true"><div className="max-w-4xl mx-auto px-4 h-[420px] rounded-2xl bg-border-warm/20 animate-pulse" /></div>,
});
const LevelQuiz = dynamic(() => import("@/components/games/LevelQuiz"), {
  loading: () => <div className="py-16 md:py-20" aria-hidden="true"><div className="max-w-2xl mx-auto px-4 h-[460px] rounded-2xl bg-border-warm/20 animate-pulse" /></div>,
});
