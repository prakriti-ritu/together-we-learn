    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
      <div className="flex gap-2 px-3 py-2.5 bg-panel/95 backdrop-blur-md border-t border-white/10">
        <a
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 py-3 bg-white text-panel font-semibold text-sm rounded-xl min-h-[48px] shadow-button active:scale-[0.97] transition-transform"
        >
